 ...
 */
package org.cibseven.bpm.extension.reactor.projectreactor.spec;

import org.cibseven.bpm.extension.reactor.projectreactor.Environment;
import org.cibseven.bpm.extension.reactor.projectreactor.Event;
import org.cibseven.bpm.extension.reactor.projectreactor.EventBus;
import org.cibseven.bpm.extension.reactor.projectreactor.filter.Filter;
import org.cibseven.bpm.extension.reactor.projectreactor.filter.FirstFilter;
import org.cibseven.bpm.extension.reactor.projectreactor.filter.PassThroughFilter;
import org.cibseven.bpm.extension.reactor.projectreactor.filter.RandomFilter;
import org.cibseven.bpm.extension.reactor.projectreactor.filter.RoundRobinFilter;
import org.cibseven.bpm.extension.reactor.projectreactor.filter.TraceableDelegatingFilter;
...
import org.cibseven.bpm.extension.reactor.projectreactor.routing.TraceableDelegatingRouter;
import org.cibseven.bpm.extension.reactor.projectreactor.Dispatcher;
import org.cibseven.bpm.extension.reactor.projectreactor.dispatch.TraceableDelegatingDispatcher;
import org.cibseven.bpm.extension.reactor.projectreactor.support.Assert;
 ...
 * {@link Dispatcher}, and {@link org.cibseven.bpm.extension.reactor.projectreactor.routing.Router}.
 *
...
public abstract class EventRoutingComponentSpec<SPEC extends EventRoutingComponentSpec<SPEC, TARGET>, TARGET> extends
  ...
  /**
   * Configures the {@link org.cibseven.bpm.extension.reactor.projectreactor.registry.Registry} to use when creating this component. Registries can be
