...
import org.cibseven.bpm.extension.reactor.projectreactor.config.ConfigurationReader;
import org.cibseven.bpm.extension.reactor.projectreactor.config.DispatcherConfiguration;
import org.cibseven.bpm.extension.reactor.projectreactor.config.DispatcherType;
import org.cibseven.bpm.extension.reactor.projectreactor.config.PropertiesConfigurationReader;
import org.cibseven.bpm.extension.reactor.projectreactor.config.ReactorConfiguration;
import org.cibseven.bpm.extension.reactor.projectreactor.dispatch.DispatcherSupplier;
import org.cibseven.bpm.extension.reactor.projectreactor.dispatch.MpscDispatcher;
import org.cibseven.bpm.extension.reactor.projectreactor.dispatch.RingBufferDispatcher;
import org.cibseven.bpm.extension.reactor.projectreactor.dispatch.SynchronousDispatcher;
import org.cibseven.bpm.extension.reactor.projectreactor.dispatch.TailRecurseDispatcher;
import org.cibseven.bpm.extension.reactor.projectreactor.dispatch.ThreadPoolExecutorDispatcher;
import org.cibseven.bpm.extension.reactor.projectreactor.dispatch.WorkQueueDispatcher;
import org.cibseven.bpm.extension.reactor.projectreactor.dispatch.wait.AgileWaitingStrategy;
import org.cibseven.bpm.extension.reactor.projectreactor.internal.PlatformDependent;
import org.cibseven.bpm.extension.reactor.projectreactor.processor.CancelException;
import org.cibseven.bpm.extension.reactor.projectreactor.timer.HashWheelTimer;
import org.cibseven.bpm.extension.reactor.projectreactor.timer.Timer;
...
public class Environment implements Iterable<Map.Entry<String, Dispatcher>>, Closeable {
  ...
  /**
   * Creates a new Environment that will use a {@link org.cibseven.bpm.extension.reactor.projectreactor.config.PropertiesConfigurationReader} to obtain its
