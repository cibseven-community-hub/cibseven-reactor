 ...
 * use simple keys, they use {@link org.cibseven.bpm.extension.reactor.projectreactor.selector.Selector}s to map their objects.
 *
...
public interface Registry<K, V> extends Iterable<Registration<K, ? extends V>> {
  ...
  /**
   * Assign the given {@link org.cibseven.bpm.extension.reactor.projectreactor.selector.Selector} with the given object.
   *
