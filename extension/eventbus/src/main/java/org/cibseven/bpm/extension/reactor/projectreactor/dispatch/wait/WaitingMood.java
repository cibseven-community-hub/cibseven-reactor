...
package org.cibseven.bpm.extension.reactor.projectreactor.dispatch.wait;

import org.cibseven.bpm.extension.reactor.projectreactor.Dispatcher;

/**
 * A Component with some waiting capacities such as {@link Dispatcher} that uses a CPU-friendly strategy
