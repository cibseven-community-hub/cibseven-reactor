...
public final class PublisherFactory {
  ...
  public static <T, C> Publisher<T> forEach(final Consumer<SubscriberWithContext<T, C>> requestConsumer,
                                            Function<Subscriber<? super T>, C> contextFactory,
                                            Consumer<C> shutdownConsumer) {
    requireNonNull(requestConsumer, "A data producer must be provided");
  ...
  public static <I, O> Publisher<O> intercept(Publisher<? extends I> source,
                                              Function<Subscriber<? super O>, SubscriberBarrier<I, O>>
                                                barrierProvider) {
    requireNonNull(source, "A data source must be provided");
    requireNonNull(barrierProvider, "A barrier interceptor must be provided");
