...
package org.cibseven.bpm.extension.reactor.projectreactor.config;
...
public class ReactorConfiguration {
  ...
  public ReactorConfiguration(List<DispatcherConfiguration> dispatcherConfigurations, String defaultDispatcherName, Properties properties) {
    requireNonNull(dispatcherConfigurations, "'dispatcherConfigurations' must not be null");
    requireNonNull(defaultDispatcherName, "'defaultDispatcherName' must not be null");
