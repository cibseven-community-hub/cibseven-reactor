...
package org.cibseven.bpm.extension.reactor.projectreactor.timer;
...
import org.cibseven.bpm.extension.reactor.projectreactor.selector.HeaderResolver;
...
import org.cibseven.bpm.extension.reactor.projectreactor.support.NamedDaemonThreadFactory;
import org.cibseven.bpm.extension.reactor.projectreactor.support.ReactorFatalException;
...
/**
 * A hashed wheel timer implementation that uses a {@link org.cibseven.bpm.extension.reactor.projectreactor.registry.Registry} and custom {@link
 * org.cibseven.bpm.extension.reactor.projectreactor.selector.Selector Selectors} to determine when tasks should be executed.
 * <p>
