...
package org.cibseven.community.reactor.projectreactor;
...
import org.cibseven.community.reactor.projectreactor.dispatch.SynchronousDispatcher;
import org.cibseven.community.reactor.projectreactor.filter.PassThroughFilter;
import org.cibseven.community.reactor.projectreactor.publisher.BusPublisher;
import org.cibseven.community.reactor.projectreactor.registry.CachingRegistry;
import org.cibseven.community.reactor.projectreactor.registry.Registration;
import org.cibseven.community.reactor.projectreactor.registry.Registries;
import org.cibseven.community.reactor.projectreactor.registry.Registry;
import org.cibseven.community.reactor.projectreactor.routing.ConsumerFilteringRouter;
import org.cibseven.community.reactor.projectreactor.routing.Router;
import org.cibseven.community.reactor.projectreactor.selector.ClassSelector;
import org.cibseven.community.reactor.projectreactor.selector.Selector;
import org.cibseven.community.reactor.projectreactor.selector.Selectors;
import org.cibseven.community.reactor.projectreactor.spec.EventBusSpec;
import org.cibseven.community.reactor.projectreactor.support.UUIDUtils;
...
public class EventBus implements Bus<Event<?>>, Consumer<Event<?>> {
  ...
  /**
   * Create a new {@link org.cibseven.community.reactor.projectreactor.spec.EventBusSpec} to configure a Reactor.
   *
   ...
   * org.cibseven.community.reactor.projectreactor.routing.Router} that broadcast events to all of the registered consumers that {@link
  ...
  /**
   * Get the {@link org.cibseven.community.reactor.projectreactor.routing.Router} used to route events to {@link Consumer Consumers}.
   *
   * @return The {@link org.cibseven.community.reactor.projectreactor.routing.Router}.
   */
  ...
  /**
   * Register the given {@link Consumer} on an anonymous {@link org.cibseven.community.reactor.projectreactor.selector.Selector} and
