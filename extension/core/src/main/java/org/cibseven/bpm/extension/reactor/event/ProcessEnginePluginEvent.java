...
public abstract class ProcessEnginePluginEvent<T, S> extends Event<T> {
  ...
  /**
   * Fired on {@link org.cibseven.bpm.engine.impl.cfg.ProcessEnginePlugin#preInit(ProcessEngineConfigurationImpl)}
   *
  ...
  /**
   * Fired on {@link org.cibseven.bpm.engine.impl.cfg.ProcessEnginePlugin#postInit(ProcessEngineConfigurationImpl)}
   *
  ...
  /**
   * Fired on {@link org.cibseven.bpm.engine.impl.cfg.ProcessEnginePlugin#postProcessEngineBuild(ProcessEngine)}
   *
