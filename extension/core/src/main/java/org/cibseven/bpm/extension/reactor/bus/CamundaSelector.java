...
public @interface CamundaSelector {
  ...
  /**
   * Restrict listening to a certain activity type. You can use the type constants provided by {@link org.cibseven.bpm.engine.ActivityTypes}.
   *
  ...
  /**
   * Restrict listening to the events specified in {@link org.cibseven.bpm.engine.delegate.TaskListener} and {@link org.cibseven.bpm.engine.delegate.ExecutionListener}.
   * @return camunda event to listen to (for example {@link org.cibseven.bpm.engine.delegate.TaskListener#EVENTNAME_CREATE}, or default "" (meaning: all events).
   */
