...
public final class Exceptions {
  ...
  public static class ValueCause extends RuntimeException {
     ...
     *
     * @param value the item that the component was trying to emit at the time of the exception
     */
     ...
     *
     * @param value the item that the Observable was trying to emit at the time of the exception
