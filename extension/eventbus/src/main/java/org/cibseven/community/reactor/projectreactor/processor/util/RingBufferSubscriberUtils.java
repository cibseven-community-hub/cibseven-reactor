package org.cibseven.community.reactor.projectreactor.processor.util;
...
import org.cibseven.community.reactor.projectreactor.processor.MutableSignal;
import org.cibseven.community.reactor.projectreactor.support.Exceptions;
import org.cibseven.community.reactor.projectreactor.support.NonBlocking;
import org.cibseven.community.reactor.projectreactor.support.SpecificationExceptions;
    ...
    private class WriteWithSubscriber implements Subscriber<E>, NonBlocking {
      ...
      public void onNext(E e) {
        ...
        if (previous >= 0) {
          ...
          throw org.cibseven.community.reactor.projectreactor.processor.InsufficientCapacityException.get();
        }
      }
