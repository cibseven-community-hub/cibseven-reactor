 ...
 */
package org.cibseven.community.reactor.projectreactor.spec;

import org.cibseven.community.reactor.projectreactor.Environment;
import org.cibseven.community.reactor.projectreactor.Event;
import org.cibseven.community.reactor.projectreactor.EventBus;
import org.cibseven.community.reactor.projectreactor.filter.Filter;
import org.cibseven.community.reactor.projectreactor.filter.FirstFilter;
import org.cibseven.community.reactor.projectreactor.filter.PassThroughFilter;
import org.cibseven.community.reactor.projectreactor.filter.RandomFilter;
import org.cibseven.community.reactor.projectreactor.filter.RoundRobinFilter;
import org.cibseven.community.reactor.projectreactor.filter.TraceableDelegatingFilter;
...
import org.cibseven.community.reactor.projectreactor.routing.TraceableDelegatingRouter;
import org.cibseven.community.reactor.projectreactor.Dispatcher;
import org.cibseven.community.reactor.projectreactor.dispatch.TraceableDelegatingDispatcher;
import org.cibseven.community.reactor.projectreactor.support.Assert;
 ...
 * {@link Dispatcher}, and {@link org.cibseven.community.reactor.projectreactor.routing.Router}.
 *
...
public abstract class EventRoutingComponentSpec<SPEC extends EventRoutingComponentSpec<SPEC, TARGET>, TARGET> extends
  ...
  /**
   * Configures the {@link org.cibseven.community.reactor.projectreactor.registry.Registry} to use when creating this component. Registries can be
