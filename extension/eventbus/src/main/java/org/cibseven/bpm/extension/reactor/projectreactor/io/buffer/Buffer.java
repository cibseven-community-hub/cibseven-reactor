...
package org.cibseven.bpm.extension.reactor.projectreactor.io.buffer;
...
public class Buffer implements Recyclable, Comparable<Buffer>, Iterable<Byte>, ReadableByteChannel, WritableByteChannel {
  ...
  /**
   * A delimiting buffer is sent to {@link org.cibseven.bpm.extension.reactor.projectreactor.io.codec.BufferCodec} and other components to signal the end of a sequence of Buffer.
   *
   * @since 2.0.4
   */
