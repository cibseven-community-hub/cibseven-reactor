package org.cibseven.bpm.extension.reactor.projectreactor.processor.util;
...
import org.cibseven.bpm.extension.reactor.projectreactor.processor.MutableSignal;
import org.cibseven.bpm.extension.reactor.projectreactor.support.Exceptions;
import org.cibseven.bpm.extension.reactor.projectreactor.support.NonBlocking;
import org.cibseven.bpm.extension.reactor.projectreactor.support.SpecificationExceptions;
    ...
    private class WriteWithSubscriber implements Subscriber<E>, NonBlocking {
      ...
      public void onNext(E e) {
        ...
        if (previous >= 0) {
          ...
          throw org.cibseven.bpm.extension.reactor.projectreactor.processor.InsufficientCapacityException.get();
        }
      }
