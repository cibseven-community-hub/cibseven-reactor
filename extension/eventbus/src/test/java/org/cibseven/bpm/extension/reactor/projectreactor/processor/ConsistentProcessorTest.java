...
import org.cibseven.bpm.extension.reactor.projectreactor.AbstractReactorTest;
 ...
 */
@Ignore
public class ConsistentProcessorTest extends AbstractReactorTest {
    ...
    public void testMultipleConsumersMultipleTimes() throws Exception {
        ...
        for (int t = 0; t < iter; t++) {
            ...
            assertThat(clientDatas.size()).isEqualTo(threads);
            ...
            assertThat(numbersNoEndsInt).hasSize(numbersNoEnds.size())
              .withFailMessage(msg);
        }
