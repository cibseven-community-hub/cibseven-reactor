...
public class SimpleCachingRegistry<K, V> implements Registry<K, V> {
  ...
  private final ConcurrentHashMap<Object, List<Registration<K, ? extends V>>> cache = new ConcurrentHashMap<>();
  private final ConcurrentHashMap<Selector<K>, List<Registration<K, ? extends V>>> registrations = new ConcurrentHashMap<>();
