...
package org.cibseven.bpm.extension.reactor.projectreactor.registry;
...
import org.cibseven.bpm.extension.reactor.projectreactor.Pausable;
...
public interface Registration<K, V> extends Pausable {
  ...
  /**
   * The {@link org.cibseven.bpm.extension.reactor.projectreactor.selector.Selector} that was used when the registration was made.
   *
   ...
   * Dispatcher} implementations should respect this value and perform
   * the cancellation.
   *
   * @return {@literal this}
   */
