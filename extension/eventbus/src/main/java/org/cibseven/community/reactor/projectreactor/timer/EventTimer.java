...
package org.cibseven.community.reactor.projectreactor.timer;
...
import org.cibseven.community.reactor.projectreactor.selector.HeaderResolver;
...
import org.cibseven.community.reactor.projectreactor.support.NamedDaemonThreadFactory;
import org.cibseven.community.reactor.projectreactor.support.ReactorFatalException;
...
/**
 * A hashed wheel timer implementation that uses a {@link org.cibseven.community.reactor.projectreactor.registry.Registry} and custom {@link
 * org.cibseven.community.reactor.projectreactor.selector.Selector Selectors} to determine when tasks should be executed.
 * <p>
