...
import org.cibseven.community.reactor.projectreactor.config.ConfigurationReader;
import org.cibseven.community.reactor.projectreactor.config.DispatcherConfiguration;
import org.cibseven.community.reactor.projectreactor.config.DispatcherType;
import org.cibseven.community.reactor.projectreactor.config.PropertiesConfigurationReader;
import org.cibseven.community.reactor.projectreactor.config.ReactorConfiguration;
import org.cibseven.community.reactor.projectreactor.dispatch.DispatcherSupplier;
import org.cibseven.community.reactor.projectreactor.dispatch.MpscDispatcher;
import org.cibseven.community.reactor.projectreactor.dispatch.RingBufferDispatcher;
import org.cibseven.community.reactor.projectreactor.dispatch.SynchronousDispatcher;
import org.cibseven.community.reactor.projectreactor.dispatch.TailRecurseDispatcher;
import org.cibseven.community.reactor.projectreactor.dispatch.ThreadPoolExecutorDispatcher;
import org.cibseven.community.reactor.projectreactor.dispatch.WorkQueueDispatcher;
import org.cibseven.community.reactor.projectreactor.dispatch.wait.AgileWaitingStrategy;
import org.cibseven.community.reactor.projectreactor.internal.PlatformDependent;
import org.cibseven.community.reactor.projectreactor.processor.CancelException;
import org.cibseven.community.reactor.projectreactor.timer.HashWheelTimer;
import org.cibseven.community.reactor.projectreactor.timer.Timer;
...
public class Environment implements Iterable<Map.Entry<String, Dispatcher>>, Closeable {
  ...
  /**
   * Creates a new Environment that will use a {@link org.cibseven.community.reactor.projectreactor.config.PropertiesConfigurationReader} to obtain its
